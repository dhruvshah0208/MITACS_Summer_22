...
(**)
(*ffCartPendulumGeneral::usage = "*)
(*ffCartPendulumGeneral[n_,\[Tau]_,\[Tau]1_,A_]*)
...
(*";*)
(**)
(*TestSwingUpGeneral::usage = "*)
(*TestSwingUpGeneral[\[Tau]_,\[Tau]1_,uff0_,A_]*)
(*Test the approximate solution on the open-loop dynamics*)
(*{xs,\[Theta]s,xdots,\[Theta]dots}*)
(*";*)
(**)
(*TestSwingUpGeneralFB::usage = "*)
(*TestSwingUpGeneralFB[\[Tau]_,\[Tau]1_,xff0_,xdotff0_,\[Theta]ff0_,\[Theta]dotff0_,uff0_,A_]*)
...
(*TestSwingUpGeneralFBNumeric[\[Tau]_,\[Tau]1_,xff0_,xdotff0_,\[Theta]ff0_,\[Theta]dotff0_,uff0_,A_,KTable_,n_]*)
...
(*ffCartPendulumGeneral[ICs_,n_,\[Tau]_,\[Tau]1_,A_]:=Module[{x,xdot,f,\[Theta],\[Theta]dot,\[Lambda]1,\[Lambda]2,\[Lambda]3,\[Lambda]4,\[CapitalDelta]t,bcs,eqns,sv,froot,xff,xdotff,xff0,xdotff0,\[Theta]ff0,\[Theta]dotff0,uff0,\[Theta]ff,\[Theta]dotff,uff},\[CapitalDelta]t=\[Tau]/n;*)
...
(*{xff,xdotff,\[Theta]ff,\[Theta]dotff,uff}]*)
(**)
(*TestSwingUpGeneral[ICs_,\[Tau]_,\[Tau]1_,uff0_,A_]:=Module[{eq,init,x,xdot,\[Theta],\[Theta]dot,xs,xdots,\[Theta]s,\[Theta]dots,t,J},*)
...
(*	    p1a,p1b,p1c,J,J1},*)
(**)
(*{x1a,xdot1a,\[Theta]1a,\[Theta]dot1a,u1a}=ffCartPendulumGeneral[ICs,n,\[Tau],\[Tau]1,A];  *)
(*{x1b,xdot1b,\[Theta]1b,\[Theta]dot1b,u1b,J1}=TestSwingUpGeneral[ICs,\[Tau],\[Tau]1,u1a,A]; *)
...
(*{x1b,xdot1b,\[Theta]1b,\[Theta]dot1b,u1b,_}=TestSwingUpGeneral[ICs,\[Tau],\[Tau]1,u1a,A]; *)
...
(*
Use this to import the package. And use the following syntax to call the appropriate functions
*)
...
(* ::Code::Initialization::Bold:: *)
n=7;\[Tau]=5;\[Tau]1= \[Tau]*1.25 ;n2 = 40;
...
Js = 0;
For[i = 0, i < M, i++,
	{x1a,xdot1a,\[Theta]1a,\[Theta]dot1a,u1a}=ffCartPendulumGeneral[ICs,n,\[Tau]*(1-i/M),\[Tau]1,A];  
	...
	(*If condition is true*)
		{x1b,xdot1b,\[Theta]1b,\[Theta]dot1b,u1b,J}=TestSwingUpGeneral[ICs,\[Tau]*1/M,\[Tau]*1/M,u1a,A]; 
	...
	(*If condition is false*)
		{x1b,xdot1b,\[Theta]1b,\[Theta]dot1b,u1b,J}=TestSwingUpGeneral[ICs,\[Tau]*1/M,\[Tau]*1/M + \[Tau]1 - \[Tau],u1a,A]; 
